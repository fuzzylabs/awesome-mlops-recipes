...
echo "================================================"
echo "  Building and Pushing Metaflow Service Image"
echo "================================================"
echo ""

# Configuration
ECR_REPOSITORY="rag-metaflow"
IMAGE_TAG="${1:-latest}"
...
echo "Building Docker image (lightweight metaflow service only)..."
...
echo ""
echo "Image: ${FULL_IMAGE_NAME}"
echo "Note: This is a lightweight image for the metadata service only."
echo "      Use 'make build-pipeline-image' for the full pipeline image."
echo ""
